...
/**
 * Rule Pool Service Integration Test (JavaScript version)
...
const { RulePoolService } = require('./out/rulePoolService.js');
const { RuleExtractionService } = require('./out/ruleExtractionService.js');
